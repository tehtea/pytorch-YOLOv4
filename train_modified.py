...
def train(model, device, config, epochs=5, batch_size=1, save_cp=True, log_step=20, img_scale=0.5):
    ...
    writer = SummaryWriter(log_dir=config.TRAIN_TENSORBOARD_DIR,
                           filename_suffix='OPT_{}_LR_{}_BS_{}_Sub_{}_Size_{}'
                            .format(config.TRAIN_OPTIMIZER, config.learning_rate, config.batch, config.subdivisions, config.width),
                           comment='OPT_{}_LR_{}_BS_{}_Sub_{}_Size_{}'
                            .format(config.TRAIN_OPTIMIZER, config.learning_rate, config.batch, config.subdivisions, config.width)
...
def get_args(**kwargs):
    ...
    parser.add_argument('-s', '--subdivisions', metavar='S', type=int, nargs='?', default=2,
                        help='Subdivisions', dest='subdivisions')
    ...
    parser.add_argument('-c', '--cfg', type=str, default=None,
                        help='config file', dest='cfg_file')
